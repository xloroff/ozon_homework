...
const (
	OrderAPI_Create_FullMethodName = "/gitlab.ozon.dev.xloroff.ozon_hw.loms.pkg.api.order.v1.OrderAPI/Create"
	OrderAPI_Info_FullMethodName   = "/gitlab.ozon.dev.xloroff.ozon_hw.loms.pkg.api.order.v1.OrderAPI/Info"
	OrderAPI_Pay_FullMethodName    = "/gitlab.ozon.dev.xloroff.ozon_hw.loms.pkg.api.order.v1.OrderAPI/Pay"
	OrderAPI_Cancel_FullMethodName = "/gitlab.ozon.dev.xloroff.ozon_hw.loms.pkg.api.order.v1.OrderAPI/Cancel"
)
...
func (c *orderAPIClient) Create(ctx context.Context, in *OrderCreateRequest, opts ...grpc.CallOption) (*OrderCreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrderAPI_Create_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderAPIClient) Info(ctx context.Context, in *OrderInfoRequest, opts ...grpc.CallOption) (*OrderInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrderAPI_Info_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderAPIClient) Pay(ctx context.Context, in *OrderPayRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, OrderAPI_Pay_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderAPIClient) Cancel(ctx context.Context, in *OrderCancelRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, OrderAPI_Cancel_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrderAPI_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderAPI_Create_FullMethodName,
	}
...
func _OrderAPI_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderAPI_Info_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrderAPI_Pay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderAPI_Pay_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _OrderAPI_Cancel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderAPI_Cancel_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var OrderAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gitlab.ozon.dev.xloroff.ozon_hw.loms.pkg.api.order.v1.OrderAPI",
