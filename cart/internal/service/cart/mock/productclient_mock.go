...
type ProductClientMock struct {
	...
	funcGetProduct          func(ctx context.Context, skuID int64) (pp1 *model.ProductResp, err error)
...
// NewProductClientMock returns a mock for cart.ProductClient
...
func (mmGetProduct *mProductClientMockGetProduct) Expect(ctx context.Context, skuID int64) *mProductClientMockGetProduct {
...
func (mmGetProduct *mProductClientMockGetProduct) ExpectSkuIDParam2(skuID int64) *mProductClientMockGetProduct {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductClientMock.GetProduct mock is already set by Set")
	}
...
func (mmGetProduct *mProductClientMockGetProduct) Inspect(f func(ctx context.Context, skuID int64)) *mProductClientMockGetProduct {
...
func (mmGetProduct *mProductClientMockGetProduct) Return(pp1 *model.ProductResp, err error) *ProductClientMock {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductClientMock.GetProduct mock is already set by Set")
	}
...
func (mmGetProduct *mProductClientMockGetProduct) Set(f func(ctx context.Context, skuID int64) (pp1 *model.ProductResp, err error)) *ProductClientMock {
	if mmGetProduct.defaultExpectation != nil {
...
// Then helper
func (mmGetProduct *mProductClientMockGetProduct) When(ctx context.Context, skuID int64) *ProductClientMockGetProductExpectation {
	if mmGetProduct.mock.funcGetProduct != nil {
		mmGetProduct.mock.t.Fatalf("ProductClientMock.GetProduct mock is already set by Set")
	}
...
func (e *ProductClientMockGetProductExpectation) Then(pp1 *model.ProductResp, err error) *ProductClientMock {
...
// GetProduct implements cart.ProductClient
func (mmGetProduct *ProductClientMock) GetProduct(ctx context.Context, skuID int64) (pp1 *model.ProductResp, err error) {
